...
Welcome to Steps to Recovery ("we," "us," "our," or the "App"). These Terms of Service ("Terms") constitute a legally binding agreement between you ("User," "you," or "your") and Steps to Recovery regarding your use of our 12-Step Recovery Companion mobile application and related services (collectively, the "Services").
...
Steps to Recovery is a privacy-first mobile application designed to support individuals in 12-step recovery programs. Our Services include:

- **Digital Journaling:** Encrypted personal journaling with end-to-end encryption
- **Daily Check-ins:** Mood tracking, gratitude practice, and urge monitoring
- **Step Work Tools:** Digital worksheets and progress tracking for 12-step work
- **Clean Time Tracker:** Sobriety date tracking and milestone celebrations
- **Meeting Finder:** Location-based meeting discovery (optional)
- **Recovery Readings:** Daily inspirational content with reflection capability
- **AI Companion:** Optional AI-powered support companion
- **Cloud Sync:** Encrypted backup and multi-device synchronization

### Not a Medical Service

**IMPORTANT: Steps to Recovery is not a medical or healthcare service.**

- The App is a **self-help tool** and does not provide medical advice, diagnosis, or treatment
- We are not a substitute for professional medical care, therapy, or addiction treatment
- Always seek the advice of qualified healthcare providers for medical concerns
- In case of emergency, contact emergency services immediately (911 in the US)
- Crisis resources are available at: [SAMHSA National Helpline](tel:1-800-662-4357) (1-800-662-4357)

### Offline-First Design

The App is designed to work primarily offline, with optional cloud synchronization. You can use core features without an internet connection.
...
- If you lose your encryption key (through device loss without backup), we cannot recover your data
...
- Promotes self-harm or violence against others
...
Our commitment to your privacy is fundamental. Please review our [Privacy Policy](PRIVACY_POLICY.md), which is incorporated into these Terms by reference.

### Key Privacy Commitments

- Your recovery data is encrypted end-to-end
- We collect minimal data necessary to provide the Services
...
- Transfer, sublicense, or distribute the App
- Use automated systems to access the Services

### Open Source

Portions of our software may be open source. Open source licenses for third-party components are available upon request.
...
- Connect with sponsors (if you choose to)
...
- Does not guarantee recovery or sobriety
...
**OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID FOR THE SERVICES IN THE PAST 12 MONTHS, OR $100, WHICHEVER IS GREATER.**
...
**We strongly recommend enabling encrypted cloud backup to protect your data.**
...
Before filing a formal legal claim, we encourage you to contact us to resolve disputes informally.

**Contact:** support@stepstorecovery.app
...
If you are outside the United States, local consumer protection laws may apply. These Terms do not limit any mandatory consumer protections in your jurisdiction.
...
If you do not agree to the changes, you must stop using the Services and delete your account.
...
You may not transfer or assign these Terms without our written consent. We may assign these Terms in connection with a merger, acquisition, or sale of assets.

### Entire Agreement

These Terms, together with our Privacy Policy, constitute the entire agreement between you and Steps to Recovery.
...
**Support:** support@stepstorecovery.app  
...
- You may recommend the App as a supplementary tool
...
**BY USING STEPS TO RECOVERY, YOU ACKNOWLEDGE THAT YOU:**

1. Have read and understood these Terms
2. Agree to be bound by these Terms
3. Are at least 13 years old
4. Understand that the App is not a medical service
5. Accept responsibility for your recovery journey
6. Will seek professional help when needed

---

**Thank you for choosing Steps to Recovery. We're honored to be part of your journey.**
