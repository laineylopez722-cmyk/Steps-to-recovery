  ...
  for (let dayOfYear = 1; dayOfYear <= 366; dayOfYear++) {
    if (!readings.find((r) => r.day_of_year === dayOfYear)) {
      ...
      readings.push({
        ...
        content:
          "Today is another opportunity to choose healing and growth. Each day brings its own possibilities and challenges, and you have the strength to meet whatever comes your way.\n\nRemember that recovery is not about being perfect—it's about being persistent. It's about showing up for yourself, even on the days when it's difficult. Every step forward, no matter how small, is meaningful.\n\nYou are worthy of peace, joy, and all the good things life has to offer. Trust in your journey and be patient with yourself as you continue to grow.",
